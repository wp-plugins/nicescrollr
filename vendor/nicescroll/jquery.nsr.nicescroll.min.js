/* jquery.nicescroll
 ...
 --
 * Modified to work with the default scrollbars. Lacks the momentum while "drag on cursor" for now. / evtl. @todo
 * Modified by: Demis Patti
 */
!function( e ){
	function o(){
	...
	var r = !1, i = !1, n = 5e3, s = 2e3, l = 0, c = e, d = o();
	Array.prototype.forEach || (Array.prototype.forEach = function( e, o ){
		for( var t = 0, r = this.length; r > t; ++t )e.call( o, this[t], t, this )
	});
	var u = ["ms", "moz", "webkit", "o"], h = window.requestAnimationFrame || !1, p = window.cancelAnimationFrame || !1;
	u.forEach( function( e ){
		h || (h = window[e + "RequestAnimationFrame"]), p || (p = window[e + "CancelAnimationFrame"] || window[e + "CancelRequestAnimationFrame"])
	} );
	var m = window.MutationObserver || window.WebKitMutationObserver || !1, f = {
		...
		for( var r = ["transform", "msTransform", "webkitTransform", "MozTransform", "OTransform"], i = 0; i < r.length; i++ )if( "undefined" != typeof o.style[r[i]] ){
			t.trstyle = r[i];
			break
		}
		t.hastransform = 0 != t.trstyle, t.hastransform && (o.style[t.trstyle] = "translate3d(1px,2px,3px)", t.hastranslate3d = /translate3d/.test( o.style[t.trstyle] )), t.transitionstyle = !1, t.prefixstyle = "", t.transitionend = !1;
		...
		return t.ischrome26 && (t.prefixstyle = n[1]), t.hastransition = t.transitionstyle, t.cursorgrabvalue = e(), t.hasmousecapture = "setCapture"in o, t.hasMutationObserver = m !== !1, o = null, g = t, t
	}, v = function( e, o ){
		function t(){
		...
		function u( e, o, t ){
			...
			if( isNaN( i ) ){
				i = z[r] || 0;
				var n = 3 == i ? t ? b.win.outerHeight() - b.win.innerHeight() : b.win.outerWidth() - b.win.innerWidth() : 1;
		...
		function v( e, o, t ){
			...
			if( 0 == e.deltaMode ? (r = -Math.floor( e.deltaX * (b.opt.mousescrollstep / 54) ), i = -Math.floor( e.deltaY * (b.opt.mousescrollstep / 54) )) : 1 == e.deltaMode && (r = -Math.floor( e.deltaX * b.opt.mousescrollstep ), i = -Math.floor( e.deltaY * b.opt.mousescrollstep )), o && 0 == r && i && (r = i, i = 0), r && (b.scrollmom && b.scrollmom.stop(), b.lastdeltax += r, b.debounced( "mousewheelx", function(){
				...
				if( b.opt.nativeparentscrolling && t && !b.ispage && !b.zoomactive )if( 0 > i ){
					if( b.getScrollTop() >= b.page.maxh )return !0
				} else if( b.getScrollTop() <= 0 )return !0;
				b.scrollmom && b.scrollmom.stop(), b.lastdeltay += i, b.debounced( "mousewheely", function(){
					var e = b.lastdeltay;
		...
		var b = this;
		if( this.version = "3.4.0", this.name = "nicescroll", this.me = o, this.opt = {
				doc: c( "body" ),
				win: !1
			}, c.extend( this.opt, f ), this.opt.snapbackspeed = 80, e )for( var x in b.opt )"undefined" != typeof e[x] && (b.opt[x] = e[x]);
		...
		do this.id = "cbp_ascrail" + s++; while( document.getElementById( this.id ) );
		...
		this.canhwscroll = S.hastransform && b.opt.hwacceleration, this.ishwscroll = this.canhwscroll && b.haswrapper, this.istouchcapable = !1, S.cantouch && S.ischrome && !S.isios && !S.isandroid && (this.istouchcapable = !0, S.cantouch = !1), S.cantouch && S.ismozilla && !S.isios && (this.istouchcapable = !0, S.cantouch = !1), b.opt.enablemouselockapi || (S.hasmousecapture = !1, S.haspointerlock = !1), this.delayed = function( e, o, t, r ){
			var i = b.delaylist[e], n = (new Date).getTime();
			return !r && i && i.tt ? !1 : (i && i.tt && clearTimeout( i.tt ), void(i && i.last + t > n && !i.tt ? b.delaylist[e] = {
				last: n + t,
				tt: setTimeout( function(){
					b.delaylist[e].tt = 0, o.call()
				}, t )
			} : i && i.tt || (b.delaylist[e] = { last: n, tt: 0 }, setTimeout( function(){
				o.call()
			}, 0 ))))
			...
			b.delaylist[e] = o, r || setTimeout( function(){
				var o = b.delaylist[e];
				b.delaylist[e] = !1, o.call()
			}, t )
			...
			b.doc.translate.x = e, b.doc.translate.tx = -1 * e + "px", b.doc.css( S.trstyle, "translate3d(" + b.doc.translate.tx + "," + b.doc.translate.ty + ",0px)" ), o || b.notifyScrollEvent( b.win[0] )
			...
			b.doc.translate.x = e, b.doc.translate.tx = -1 * e + "px", b.doc.css( S.trstyle, "translate(" + b.doc.translate.tx + "," + b.doc.translate.ty + ")" ), o || b.notifyScrollEvent( b.win[0] )
		...
		this.getOffset = function(){
			...
			var e = b.win.offset(), o = b.viewport.offset();
			return { top: e.top - o.top + b.viewport.scrollTop(), left: e.left - o.left + b.viewport.scrollLeft() }
		}, this.updateScrollBar = function( e ){
			if( b.ishwscroll )b.rail.css( { height: b.win.innerHeight() } ), b.railh && b.railh.css( { width: b.win.innerWidth() } ); else{
				var o = b.getOffset(), t = { top: o.top, left: o.left };
				t.top += u( b.win, "border-top-width", !0 );
				{
					(b.win.outerWidth() - b.win.innerWidth()) / 2
				}
				t.left += b.rail.align ? b.win.outerWidth() - u( b.win, "border-right-width" ) - b.rail.width : u( b.win, "border-left-width" );
				var r = b.opt.railoffset;
				if( r && (r.top && (t.top += r.top), b.rail.align && r.left && (t.left += r.left)), b.locked || b.rail.css( {
						top: t.top,
						left: t.left,
					...
					var t = {
						top: o.top,
						left: o.left
					}, i = b.railh.align ? t.top + u( b.win, "border-top-width", !0 ) + b.win.innerHeight() - b.railh.height : t.top + u( b.win, "border-top-width", !0 ), n = t.left + u( b.win, "border-left-width" );
					b.railh.css( { top: i, left: n, width: b.railh.width } )
				}
			}
		}, this.doRailClick = function( e, o, t ){
			var r, i, n, s;
			b.locked || (b.cancelEvent( e ), o ? (r = t ? b.doScrollLeft : b.doScrollTop, n = t ? (e.pageX - b.railh.offset().left - b.cursorwidth / 2) * b.scrollratio.x : (e.pageY - b.rail.offset().top - b.cursorheight / 2) * b.scrollratio.y, r( n )) : (r = t ? b.doScrollLeftBy : b.doScrollBy, n = t ? b.scroll.x : b.scroll.y, s = t ? e.pageX - b.railh.offset().left : e.pageY - b.rail.offset().top, i = t ? b.view.w : b.view.h, r( n >= s ? i : -i )))
		}, b.hasanimationframe = h, b.hascancelanimationframe = p, b.hasanimationframe ? b.hascancelanimationframe || (p = function(){
			...
			function e( o ){
				if( b.selectiondrag ){
					if( o ){
						var t = b.win.outerHeight(), r = o.pageY - b.selectiondrag.top;
						r > 0 && t > r && (r = 0), r >= t && (r -= t), b.selectiondrag.df = r
					}
					if( 0 != b.selectiondrag.df ){
						var i = 2 * -Math.floor( b.selectiondrag.df / 6 );
						b.doScrollBy( i ), b.debounced( "doselectionscroll", function(){
							e()
						}, 50 )
					}
				}
			...
			function o(){
				...
				if( b.forcescreen = !0, b.isiframe && (b.iframe = {
					...
					}, b.docscroll = c( b.iframe.body )), !S.isios && b.opt.iframeautoresize && !b.isiframe ){
					b.win.scrollTop( 0 ), b.doc.height( "" );
					var t = Math.max( e.getElementsByTagName( "html" )[0].scrollHeight, e.body.scrollHeight );
					b.doc.height( t )
				}
				b.lazyResize( 30 ), S.isie7 && b.css( c( b.iframe.html ), { "overflow-y": "hidden" } ), b.css( c( b.iframe.body ), { "overflow-y": "hidden" } ), "contentWindow"in this ? b.bind( this.contentWindow, "scroll", b.onscroll ) : b.bind( e, "scroll", b.onscroll ), b.opt.enablemousewheel && b.bind( e, "mousewheel", b.onmousewheel ), b.opt.enablekeyboard && b.bind( e, S.isopera ? "keypress" : "keydown", b.onkeypress ), (S.cantouch || b.opt.touchbehavior) && (b.bind( e, "mousedown", b.onmousedown ), b.bind( e, "mousemove", function( e ){
					b.onmousemove( e, !0 )
				} ), b.opt.grabcursorenabled && S.cursorgrabvalue && b.css( c( e.body ), { cursor: S.cursorgrabvalue } )), b.bind( e, "mouseup", b.onmouseup ), b.zoom && (b.opt.dblclickzoom && b.bind( e, "dblclick", b.doZoom ), b.ongesturezoom && b.bind( e, "gestureend", b.ongesturezoom ))
			}
			
			if( b.saved.css = [], S.isie7mobile )return !0;
			if( S.hasmstouch && b.css( b.ispage ? c( "html" ) : b.win, { "-ms-touch-action": "none" } ), b.zindex = "auto", b.zindex = b.ispage || "auto" != b.opt.zindex ? b.opt.zindex : a() || "auto", b.ispage || "auto" == b.zindex || b.zindex > l && (l = b.zindex), b.isie && 0 == b.zindex && "auto" == b.opt.zindex && (b.zindex = "auto"), !b.ispage || !S.cantouch && !S.isieold && !S.isie9mobile ){
				var t = b.docscroll;
				b.ispage && (t = b.haswrapper ? b.win : b.doc), !S.isios || b.ispage || b.haswrapper || b.css( c( "body" ), { "-webkit-overflow-scrolling": "touch" } );
				...
				} ), s.hborder = parseFloat( s.outerHeight() - s.innerHeight() ), b.cursor = s;
				var u = c( document.createElement( "div" ) );
				u.attr( "id", b.id ), u.addClass( "nicescroll-rails" );
				var h, p, f = ["left", "right"];
				for( var g in f )p = f[g], h = b.opt.railpadding[p], h ? u.css( "padding-" + p, h + "px" ) : b.opt.railpadding[p] = 0;
				u.append( s ), u.width = Math.max( parseFloat( b.opt.cursorwidth ), s.outerWidth() ) + b.opt.railpadding.left + b.opt.railpadding.right, u.css( {
					width: u.width + "px",
					zIndex: b.zindex,
					background: b.opt.background,
					cursor: "default"
				} ), u.visibility = !0, u.scrollable = !0, u.align = "left" == b.opt.railalign ? 0 : 1, b.rail = u, b.rail.drag = !1;
				var w = !1;
				if( !b.opt.boxzoom || b.ispage || S.isieold || (w = document.createElement( "div" ), b.bind( w, "click", b.doZoom ), b.zoom = c( w ), b.zoom.css( {
						cursor: "pointer",
						"z-index": b.zindex,
					...
					s.css( {
						...
						"-moz-border-radius": b.opt.cursorborderradius,
						"border-radius": b.opt.cursorborderradius
					} ), s.wborder = parseFloat( s.outerWidth() - s.innerWidth() ), b.cursorh = s;
					var v = c( document.createElement( "div" ) );
					v.attr( "id", b.id + "-hr" ), v.addClass( "nicescroll-rails" ), v.height = Math.max( parseFloat( b.opt.cursorwidth ), s.outerHeight() ), v.css( {
						height: v.height + "px",
						zIndex: b.zindex,
						background: b.opt.background
					} ), v.append( s ), v.visibility = !0, v.scrollable = !0, v.align = "top" == b.opt.railvalign ? 0 : 1, b.railh = v, b.railh.drag = !1
				}
				if( b.ispage )u.css( {
					position: "fixed",
					top: "0px",
					height: "100%"
				} ), u.css( u.align ? { right: "0px" } : { left: "0px" } ), b.body.append( u ), b.railh && (v.css( {
					position: "fixed",
					left: "0px",
					width: "100%"
				} ), v.css( v.align ? { bottom: "0px" } : { top: "0px" } ), b.body.append( v )); else{
					if( b.ishwscroll ){
						...
						} ), x.append( b.zoom )), u.css( {
							position: "absolute",
							top: 0
						} ), u.css( u.align ? { right: 0 } : { left: 0 } ), x.append( u ), v && (v.css( {
							position: "absolute",
							left: 0,
							bottom: 0
						} ), v.css( v.align ? { bottom: 0 } : { top: 0 } ), x.append( v ))
					} else{
						b.isfixed = "fixed" == b.win.css( "position" );
						var z = b.isfixed ? "fixed" : "absolute";
						b.isfixed || (b.viewport = b.getViewport( b.win[0] )), b.viewport && (b.body = b.viewport, 0 == /relative|absolute/.test( b.viewport.css( "position" ) ) && b.css( b.viewport, { position: "relative" } )), u.css( { position: z } ), b.zoom && b.zoom.css( { position: z } ), b.updateScrollBar(), b.body.append( u ), b.zoom && b.body.append( b.zoom ), b.railh && (v.css( { position: z } ), b.body.append( v ))
					}
					S.isios && b.css( b.win, {
						"-webkit-tap-highlight-color": "rgba(0,0,0,0)",
						"-webkit-touch-callout": "none"
					} ), S.isie && b.opt.disableoutline && b.win.attr( "hideFocus", "true" ), S.iswebkit && b.opt.disableoutline && b.win.css( { outline: "none" } )
				}
				if( b.opt.autohidemode === !1 ? (b.autohidedom = !1, b.rail.css( { opacity: b.opt.cursoropacitymax } ), b.railh && b.railh.css( { opacity: b.opt.cursoropacitymax } )) : b.opt.autohidemode === !0 ? (b.autohidedom = c().add( b.rail ), S.isie8 && (b.autohidedom = b.autohidedom.add( b.cursor )), b.railh && (b.autohidedom = b.autohidedom.add( b.railh )), b.railh && S.isie8 && (b.autohidedom = b.autohidedom.add( b.cursorh ))) : "scroll" == b.opt.autohidemode ? (b.autohidedom = c().add( b.rail ), b.railh && (b.autohidedom = b.autohidedom.add( b.railh ))) : "cursor" == b.opt.autohidemode ? (b.autohidedom = c().add( b.cursor ), b.railh && (b.autohidedom = b.autohidedom.add( b.cursorh ))) : "hidden" == b.opt.autohidemode && (b.autohidedom = !1, b.hide(), b.locked = !1), S.isie9mobile ){
					b.scrollmom = new y( b ), b.onmangotouch = function(){
						var e = b.getScrollTop(), o = b.getScrollLeft();
						if( e == b.scrollmom.lastscrolly && o == b.scrollmom.lastscrollx )return !0;
						var t = e - b.mangotouch.sy, r = o - b.mangotouch.sx, i = Math.round( Math.sqrt( Math.pow( r, 2 ) + Math.pow( t, 2 ) ) );
						if( 0 != i ){
							var n = 0 > t ? -1 : 1, s = 0 > r ? -1 : 1, l = +new Date;
							if( b.mangotouch.lazy && clearTimeout( b.mangotouch.lazy ), l - b.mangotouch.tm > 80 || b.mangotouch.dry != n || b.mangotouch.drx != s )b.scrollmom.stop(), b.scrollmom.reset( o, e ), b.mangotouch.sy = e, b.mangotouch.ly = e, b.mangotouch.sx = o, b.mangotouch.lx = o, b.mangotouch.dry = n, b.mangotouch.drx = s, b.mangotouch.tm = l; else{
								b.scrollmom.stop(), b.scrollmom.update( b.mangotouch.sx - r, b.mangotouch.sy - t );
								{
									l - b.mangotouch.tm
								}
								b.mangotouch.tm = l;
								var a = Math.max( Math.abs( b.mangotouch.ly - e ), Math.abs( b.mangotouch.lx - o ) );
								b.mangotouch.ly = e, b.mangotouch.lx = o, a > 2 && (b.mangotouch.lazy = setTimeout( function(){
									b.mangotouch.lazy = !1, b.mangotouch.dry = 0, b.mangotouch.drx = 0, b.mangotouch.tm = 0, b.scrollmom.doMomentum( 30 )
								}, 100 ))
							}
						}
					};
					var T = b.getScrollTop(), k = b.getScrollLeft();
					b.mangotouch = {
						sy: T,
						ly: T,
						dry: 0,
					...
					if( S.cantouch || b.istouchcapable || b.opt.touchbehavior || S.hasmstouch ){
						b.scrollmom = new y( b ), b.ontouchstart = function( e ){
							...
							if( !b.locked ){
								if( S.hasmstouch )for( var o = e.target ? e.target : !1; o; ){
								...
								if( o ){
									...
									if( r )return b.stopPropagation( e )
								}
								...
								if( b.rail.drag = {
									...
									}, l = Math.max( 0, s.h - n.h ), a = Math.max( 0, s.w - n.w );
									b.rail.drag.ck = !b.rail.scrollable && b.railh.scrollable ? l > 0 ? "v" : !1 : b.rail.scrollable && !b.railh.scrollable && a > 0 ? "h" : !1, b.rail.drag.ck || (b.rail.drag.dl = "f")
								}
								if( b.opt.touchbehavior && b.isiframe && S.isie ){
									var d = b.win.position();
									b.rail.drag.x += d.left, b.rail.drag.y += d.top
								}
								if( b.hasmoving = !1, b.lastmouseup = !1, b.scrollmom.reset( e.clientX, e.clientY ), !S.cantouch && !this.istouchcapable && !S.hasmstouch ){
									var u = o ? /INPUT|SELECT|TEXTAREA/i.test( o.nodeName ) : !1;
									if( !u )return !b.ispage && S.hasmousecapture && o.setCapture(), b.cancelEvent( e );
							...
							return e.pointerType && 2 != e.pointerType ? !1 : b.rail.drag && 2 == b.rail.drag.pt && (b.scrollmom.doMomentum(), b.rail.drag = !1, b.hasmoving && (b.hasmoving = !1, b.lastmouseup = !0, b.hideCursor(), S.hasmousecapture && document.releaseCapture(), !S.cantouch)) ? b.cancelEvent( e ) : void 0
						};
						var M = b.opt.touchbehavior && b.isiframe && !S.hasmousecapture;
						b.ontouchmove = function( e, o ){
							...
							if( b.rail.drag && 2 == b.rail.drag.pt ){
								...
								if( e = t, "changedTouches"in e && (e.clientX = e.changedTouches[0].clientX, e.clientY = e.changedTouches[0].clientY), b.forcescreen ){
								...
								var s = e.clientY + ofy, l = s - b.rail.drag.y, a = e.clientX + i, d = a - b.rail.drag.x, u = b.rail.drag.st - l;
								if( b.ishwscroll && b.opt.bouncescroll ? 0 > u ? u = Math.round( u / 2 ) : u > b.page.maxh && (u = b.page.maxh + Math.round( (u - b.page.maxh) / 2 )) : (0 > u && (u = 0, s = 0), u > b.page.maxh && (u = b.page.maxh, s = 0)), b.railh && b.railh.scrollable ){
									var h = b.rail.drag.sl - d;
									b.ishwscroll && b.opt.bouncescroll ? 0 > h ? h = Math.round( h / 2 ) : h > b.page.maxw && (h = b.page.maxw + Math.round( (h - b.page.maxw) / 2 )) : (0 > h && (h = 0, a = 0), h > b.page.maxw && (h = b.page.maxw, a = 0))
								}
								var p = !1;
								if( b.rail.drag.dl )p = !0, "v" == b.rail.drag.dl ? h = b.rail.drag.sl : "h" == b.rail.drag.dl && (u = b.rail.drag.st); else{
									var m = Math.abs( l ), f = Math.abs( d ), g = b.opt.directionlockdeadzone;
									if( "v" == b.rail.drag.ck ){
										if( m > g && .3 * m >= f )return b.rail.drag = !1, !0;
										f > g && (b.rail.drag.dl = "f", c( "body" ).scrollTop( c( "body" ).scrollTop() ))
									} else if( "h" == b.rail.drag.ck ){
										if( f > g && m <= .3 * az )return b.rail.drag = !1, !0;
										m > g && (b.rail.drag.dl = "f", c( "body" ).scrollLeft( c( "body" ).scrollLeft() ))
									}
								}
								if( b.synched( "touchmove", function(){
										b.rail.drag && 2 == b.rail.drag.pt && (b.prepareTransition && b.prepareTransition( 0 ), b.rail.scrollable && b.setScrollTop( u ), b.scrollmom.update( a, s ), b.railh && b.railh.scrollable ? (b.setScrollLeft( h ), b.showCursor( u, h )) : b.showCursor( u ), S.isie10 && document.selection.clear())
									} ), S.ischrome && b.istouchcapable && (p = !1), p )return b.cancelEvent( e )
							}
						}
					}
					b.onmousedown = function( e, o ){
						...
						if( b.rail.drag ){
							if( S.hasmousecapture && document.releaseCapture(), b.isiframe && !S.hasmousecapture && b.doc.css( "pointer-events", b.saved.csspointerevents ), 1 != b.rail.drag.pt )return;
					...
					}, b.opt.grabcursorenabled && S.cursorgrabvalue && (b.css( b.ispage ? b.doc : b.win, { cursor: S.cursorgrabvalue } ), b.css( b.rail, { cursor: S.cursorgrabvalue } ))) : (b.hasTextSelected = "getSelection"in document ? function(){
						...
						b.selectiondrag = !1
					}, b.onselectiondrag = function( o ){
						b.selectiondrag && b.hasTextSelected() && b.debounced( "selectionscroll", function(){
							e( o )
						}, 250 )
					}), S.hasmstouch && (b.css( b.rail, { "-ms-touch-action": "none" } ), b.css( b.cursor, { "-ms-touch-action": "none" } ), b.bind( b.win, "MSPointerDown", b.ontouchstart ), b.bind( document, "MSPointerUp", b.ontouchend ), b.bind( document, "MSPointerMove", b.ontouchmove ), b.bind( b.cursor, "MSGestureHold", function( e ){
						e.preventDefault()
						...
						return b.rail.drag && 2 == b.rail.drag.pt ? void 0 : (b.rail.drag = !1, b.hasmoving = !1, b.hideCursor(), S.hasmousecapture && document.releaseCapture(), b.cancelEvent( e ))
					} )), (b.opt.cursordragontouch || !S.cantouch && !b.opt.touchbehavior) && (b.rail.css( { cursor: "default" } ), b.railh && b.railh.css( { cursor: "default" } ), b.jqbind( b.rail, "mouseenter", function(){
						...
						b.rail.active = !1, b.rail.drag || b.hideCursor()
					} ))), b.opt.enablemousewheel && (b.isiframe || b.bind( S.isie && b.ispage ? document : b.docscroll, "mousewheel", b.onmousewheel ), b.bind( b.rail, "mousewheel", b.onmousewheel ), b.railh && b.bind( b.railh, "mousewheel", b.onmousewheelhr )), b.ispage || S.cantouch || /HTML|BODY/.test( b.win[0].nodeName ) || (b.win.attr( "tabindex" ) || b.win.attr( { tabindex: n++ } ), b.jqbind( b.win, "focus", function( e ){
						r = b.getTarget( e ).id || !0, b.hasfocus = !0, b.canshowonmouseevent && b.noticeCursor()
					} ), b.jqbind( b.win, "blur", function(){
						r = !1, b.hasfocus = !1
					} ), b.jqbind( b.win, "mouseenter", function( e ){
						i = b.getTarget( e ).id || !0, b.hasmousefocus = !0, b.canshowonmouseevent && b.noticeCursor()
					} ), b.jqbind( b.win, "mouseleave", function(){
						i = !1, b.hasmousefocus = !1
					} ))
				}
				if( b.onkeypress = function( e ){
						...
						if( b.hasfocus || b.hasmousefocus && !r || b.ispage && !r && !i ){
							var n = e.keyCode;
							if( b.locked && 27 != n )return b.cancelEvent( e );
							var s = e.ctrlKey || !1, l = e.shiftKey || !1, a = !1;
							switch( n ){
								case 38:
								case 63233:
									b.doScrollBy( 72 ), a = !0;
								...
								case 37:
								case 63232:
									b.railh && (s ? b.doScrollLeft( 0 ) : b.doScrollLeftBy( 72 ), a = !0);
									break;
								case 39:
								case 63234:
									b.railh && (s ? b.doScrollLeft( b.page.maxw ) : b.doScrollLeftBy( -72 ), a = !0);
									break;
								case 33:
								case 63276:
								...
								case 36:
								case 63273:
									b.railh && s ? b.doScrollPos( 0, 0 ) : b.doScrollTo( 0 ), a = !0;
									break;
								case 35:
								case 63275:
									b.railh && s ? b.doScrollPos( b.page.maxw, b.page.maxh ) : b.doScrollTo( b.page.maxh ), a = !0;
									break;
								case 32:
									b.opt.spacebarenabled && (b.doScrollBy( l ? b.view.h : -b.view.h ), a = !0);
									break;
								case 27:
					...
					}, b.opt.enablekeyboard && b.bind( document, S.isopera && !S.isopera12 ? "keypress" : "keydown", b.onkeypress ), b.bind( window, "resize", b.lazyResize ), b.bind( window, "orientationchange", b.lazyResize ), b.bind( window, "load", b.lazyResize ), S.ischrome && !b.ispage && !b.haswrapper ){
					var E = b.win.attr( "style" ), L = parseFloat( b.win.css( "width" ) ) + 1;
				...
				b.onAttributeChange = function(){
					b.lazyResize( 250 )
				}, b.ispage || b.haswrapper || (m !== !1 ? (b.observer = new m( function( e ){
					...
					e.forEach( function( e ){
						if( e.removedNodes.length > 0 )for( var o in e.removedNodes )if( e.removedNodes[o] == b.win[0] )return b.remove()
					} )
			...
			var t = b.page.maxh, r = b.page.maxw, i = { h: b.view.h, w: b.view.w };
			if( b.view = {
					w: b.ispage ? b.win.width() : parseInt( b.win[0].clientWidth ),
					h: b.ispage ? b.win.height() : parseInt( b.win[0].clientHeight )
				}, b.page = o ? o : b.getContentSize(), b.page.maxh = Math.max( 0, b.page.h - b.view.h ), b.page.maxw = Math.max( 0, b.page.w - b.view.w ), b.page.maxh == t && b.page.maxw == r && b.view.w == i.w ){
			...
			var l = b.getScrollTop();
			return l > b.page.maxh ? b.doScrollTop( b.page.maxh ) : (b.scroll.y = Math.round( b.getScrollTop() * (1 / b.scrollratio.y) ), b.scroll.x = Math.round( b.getScrollLeft() * (1 / b.scrollratio.x) ), b.cursoractive && b.noticeCursor()), b.scroll.y && 0 == b.getScrollTop() && b.doScrollTo( Math.floor( b.scroll.y * b.scrollratio.y ) ), b
			...
			if( "mousewheel" == o )if( "onwheel"in b.win )b._bind( i, "wheel", t, r || !1 ); else{
				...
				b._bind( i, o, t, r || !1 ), S.cantouch && "mouseup" == o && b._bind( i, "touchcancel", t, r || !1 )
			} else b._bind( i, o, function( e ){
				return e = e || window.event || !1, e && e.srcElement && (e.target = e.srcElement), "pageY"in e || (e.pageX = e.clientX + document.documentElement.scrollLeft, e.pageY = e.clientY + document.documentElement.scrollTop), t.call( i, e ) === !1 || r === !1 ? b.cancelEvent( e ) : !0
			} )
			...
			for( ; o && 1 == o.nodeType && !/BODY|HTML/.test( o.nodeName ); ){
				var t = c( o ), r = t.css( "overflowY" ) || t.css( "overflowX" ) || t.css( "overflow" ) || "";
			...
			if( !b.rail.scrollable )return b.railh && b.railh.scrollable ? b.onmousewheelhr( e ) : !0;
			var o = +new Date, t = !1;
			...
			if( b.rail.drag )return b.cancelEvent( e );
			var o = +new Date, t = !1;
			return b.opt.preservenativescrolling && b.checkarea + 600 < o && (b.nativescrollingarea = b.isScrollable( e ), t = !0), b.checkarea = o, b.nativescrollingarea ? !0 : b.locked ? b.cancelEvent( e ) : v( e, !0, t )
		}, this.stop = function(){
			...
			var o = Math.round( 10 * b.opt.scrollspeed ), t = Math.min( o, Math.round( e / 20 * b.opt.scrollspeed ) );
			return t > 20 ? t : 0
		}, b.opt.smoothscroll ? b.ishwscroll && S.hastransition && b.opt.usetransition ? (this.prepareTransition = function( e, o ){
			var t = o ? e > 20 ? e : 0 : b.getTransitionSpeed( e ), r = t ? S.prefixstyle + "transform " + t + "ms ease-out" : "";
			return b.lasttransitionstyle && b.lasttransitionstyle == r || (b.lasttransitionstyle = r, b.doc.css( S.transitionstyle, r )), t
			...
			return ((b.newscrolly - r) * (o - r) < 0 || (b.newscrollx - i) * (e - i) < 0) && b.cancelScroll(), 0 == b.opt.bouncescroll && (0 > o ? o = 0 : o > b.page.maxh && (o = b.page.maxh), 0 > e ? e = 0 : e > b.page.maxw && (e = b.page.maxw)), b.scrollrunning && e == b.newscrollx && o == b.newscrolly ? !1 : (b.newscrolly = o, b.newscrollx = e, b.newscrollspeed = t || !1, b.timer ? !1 : void(b.timer = setTimeout( function(){
				var t = b.getScrollTop(), r = b.getScrollLeft(), i = {};
				i.x = e - r, i.y = o - t, i.px = r, i.py = t;
				var n = Math.round( Math.sqrt( Math.pow( i.x, 2 ) + Math.pow( i.y, 2 ) ) ), s = b.newscrollspeed && b.newscrollspeed > 1 ? b.newscrollspeed : b.getTransitionSpeed( n );
				if( b.newscrollspeed && b.newscrollspeed <= 1 && (s *= b.newscrollspeed), b.prepareTransition( s, !0 ), b.timerscroll && b.timerscroll.tm && clearInterval( b.timerscroll.tm ), s > 0 ){
					...
					S.transitionend ? b.scrollendtrapped || (b.scrollendtrapped = !0, b.bind( b.doc, S.transitionend, b.onScrollEnd, !1 )) : (b.scrollendtrapped && clearTimeout( b.scrollendtrapped ), b.scrollendtrapped = setTimeout( b.onScrollEnd, s ));
					var a = t, c = r;
					b.timerscroll = {
						bz: new BezierClass( a, b.newscrolly, s, 0, 0, .58, 1 ),
			...
			var e = b.getScrollTop(), o = b.getScrollLeft();
			return b.scrollrunning = !1, S.transitionend || clearTimeout( S.transitionend ), b.scrollendtrapped = !1, b._unbind( b.doc, S.transitionend, b.onScrollEnd ), b.prepareTransition( 0 ), b.setScrollTop( e ), b.railh && b.setScrollLeft( o ), b.timerscroll && b.timerscroll.tm && clearInterval( b.timerscroll.tm ), b.timerscroll = !1, b.cursorfreezed = !1, b.showCursor( e, o ), b
		}, this.onScrollEnd = function(){
			b.scrollendtrapped && b._unbind( b.doc, S.transitionend, b.onScrollEnd ), b.scrollendtrapped = !1, b.prepareTransition( 0 ), b.timerscroll && b.timerscroll.tm && clearInterval( b.timerscroll.tm ), b.timerscroll = !1;
			var e = b.getScrollTop(), o = b.getScrollLeft();
			if( b.setScrollTop( e ), b.railh && b.setScrollLeft( o ), b.noticeCursor( !1, e, o ), b.cursorfreezed = !1, 0 > e ? e = 0 : e > b.page.maxh && (e = b.page.maxh), 0 > o ? o = 0 : o > b.page.maxw && (o = b.page.maxw), e != b.newscrolly || o != b.newscrollx )return b.doScrollPos( o, e, b.opt.snapbackspeed );
			if( b.onscrollend && b.scrollrunning ){
				var t = { type: "scrollend", current: { x: o, y: e }, end: { x: b.newscrollx, y: b.newscrolly } };
			...
			function r(){
				...
				if( b.scrollrunning = !0, d = 1 - d )return b.timer = h( r ) || 1;
				var e = 0, o = sy = b.getScrollTop();
				if( b.dst.ay ){
					o = b.bzscroll ? b.dst.py + b.bzscroll.getNow() * b.dst.ay : b.newscrolly;
					var t = o - sy;
					(0 > t && o < b.newscrolly || t > 0 && o > b.newscrolly) && (o = b.newscrolly), b.setScrollTop( o ), o == b.newscrolly && (e = 1)
				} else e = 1;
				var i = sx = b.getScrollLeft();
				if( b.dst.ax ){
					i = b.bzscroll ? b.dst.px + b.bzscroll.getNow() * b.dst.ax : b.newscrollx;
					var t = i - sx;
					(0 > t && i < b.newscrollx || t > 0 && i > b.newscrollx) && (i = b.newscrollx), b.setScrollLeft( i ), i == b.newscrollx && (e += 1)
				} else e += 1;
				if( 2 == e ){
					if( b.timer = 0, b.cursorfreezed = !1, b.bzscroll = !1, b.scrollrunning = !1, 0 > o ? o = 0 : o > b.page.maxh && (o = b.page.maxh), 0 > i ? i = 0 : i > b.page.maxw && (i = b.page.maxw), i != b.newscrollx || o != b.newscrolly )b.doScrollPos( i, o ); else if( b.onscrollend ){
						var n = {
							type: "scrollend",
							current: { x: sx, y: sy },
							end: { x: b.newscrollx, y: b.newscrolly }
			...
			var o = "undefined" == typeof o || o === !1 ? b.getScrollTop( !0 ) : o;
			if( b.timer && b.newscrolly == o && b.newscrollx == e )return !0;
			b.timer && p( b.timer ), b.timer = 0;
			var i = b.getScrollTop(), n = b.getScrollLeft();
			...
			var l = 0, a = s;
			0 == b.dst.x ? (l = i, a = o, b.dst.ay = 1, b.dst.py = 0) : 0 == b.dst.y && (l = n, a = e, b.dst.ax = 1, b.dst.px = 0);
			var c = b.getTransitionSpeed( s );
			if( t && 1 >= t && (c *= t), b.bzscroll = c > 0 ? b.bzscroll ? b.bzscroll.update( a, c ) : new BezierClass( l, a, c, 0, 1, 0, 1 ) : !1, !b.timer ){
				...
				if( b.cancelAnimationFrame = !1, b.timer = 1, b.onscrollstart && !b.scrollrunning ){
					...
					b.onscrollstart.call( b, u )
				}
				r(), (i == b.page.maxh && o >= i || n == b.page.maxw && e >= n) && b.checkContentSize(), b.noticeCursor()
			}
		}, this.cancelScroll = function(){
			return b.timer && p( b.timer ), b.timer = 0, b.bzscroll = !1, b.scrollrunning = !1, b
		}) : (this.doScrollLeft = function( e, o ){
			...
			0 > r && (r = 0), b.synched( "scroll", function(){
				b.setScrollTop( r ), b.setScrollLeft( t )
			} )
		}, this.cancelScroll = function(){
		}), this.doScrollBy = function( e, o ){
			var t = 0;
			if( o )t = Math.floor( (b.scroll.y - e) * b.scrollratio.y ); else{
				var r = b.timer ? b.newscrolly : b.getScrollTop( !0 );
				t = r - e
			}
			if( b.bouncescroll ){
			...
			return b.cursorfreezed = !1, py = b.getScrollTop( !0 ), 0 > t && py <= 0 ? b.noticeCursor() : t > b.page.maxh && py >= b.page.maxh ? (b.checkContentSize(), b.noticeCursor()) : void b.doScrollTop( t )
		}, this.doScrollLeftBy = function( e, o ){
			var t = 0;
			if( o )t = Math.floor( (b.scroll.x - e) * b.scrollratio.x ); else{
				var r = b.timer ? b.newscrollx : b.getScrollLeft( !0 );
				t = r - e
			}
			if( b.bouncescroll ){
			...
			return b.cursorfreezed = !1, px = b.getScrollLeft( !0 ), 0 > t && px <= 0 ? b.noticeCursor() : t > b.page.maxw && px >= b.page.maxw ? b.noticeCursor() : void b.doScrollLeft( t )
		}, this.doScrollTo = function( e, o ){
			var t = o ? Math.round( e * b.scrollratio.y ) : e;
			0 > t ? t = 0 : t > b.page.maxh && (t = b.page.maxh), b.cursorfreezed = !1, b.doScrollTop( e )
			...
			if( !b.zoomactive ){
				...
				var o = ["position", "top", "left", "zIndex", "backgroundColor", "marginTop", "marginBottom", "marginLeft", "marginRight"], t = b.win[0].style;
				for( var r in o ){
					var i = o[r];
					b.zoomrestore.style[i] = "undefined" != typeof t[i] ? t[i] : ""
				}
				b.zoomrestore.style.width = b.win.css( "width" ), b.zoomrestore.style.height = b.win.css( "height" ), b.zoomrestore.padding = {
					w: b.win.outerWidth() - b.win.width(),
					h: b.win.outerHeight() - b.win.height()
				}, S.isios4 && (b.zoomrestore.scrollTop = c( window ).scrollTop(), c( window ).scrollTop( 0 )), b.win.css( {
				...
				var n = b.win.css( "backgroundColor" );
				return ("" == n || /transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test( n )) && b.win.css( "backgroundColor", "#fff" ), b.rail.css( { "z-index": l + 101 } ), b.zoom.css( { "z-index": l + 102 } ), b.zoom.css( "backgroundPosition", "0px -18px" ), b.resizeZoom(), b.onzoomin && b.onzoomin.call( b ), b.cancelEvent( e )
			}
		}, this.doZoomOut = function( e ){
			return b.zoomactive ? (b.zoomactive = !1, b.win.css( "margin", "" ), b.win.css( b.zoomrestore.style ), S.isios4 && c( window ).scrollTop( b.zoomrestore.scrollTop ), b.rail.css( { "z-index": b.zindex } ), b.zoom.css( { "z-index": b.zindex } ), b.zoomrestore = !1, b.zoom.css( "backgroundPosition", "0px 0px" ), b.onResize(), b.onzoomout && b.onzoomout.call( b ), b.cancelEvent( e )) : void 0
			...
			if( b.zoomactive ){
				...
				b.win.css( {
					width: c( window ).width() - b.zoomrestore.padding.w + "px",
					height: c( window ).height() - b.zoomrestore.padding.h + "px"
	...
	e.cssHooks.pageYOffset = {
		get: function( e ){
			...
			return o && o.ishwscroll ? o.getScrollTop() : b.call( e )
		}, set: function( e, o ){
		...
		return this.each( function(){
			...
			o && o.ishwscroll ? o.setScrollTop( parseInt( e ) ) : b.call( c( this ), e )
		} )
	};
	...
	c.cssHooks.pageXOffset = {
		...
		return this.each( function(){
			var o = c.data( this, "__nicescroll" ) || !1;
			o && o.ishwscroll ? o.setScrollLeft( parseInt( e ) ) : x.call( c( this ), e )
		} )
	};
	var S = function( e ){
		var o = this;
		if( this.length = 0, this.name = "nicescrollarray", this.each = function( e ){
				for( var t = 0; t < o.length; t++ )e.call( o[t] );
				return o
	...
	t( S.prototype, ["show", "hide", "toggle", "onResize", "resize", "remove", "stop", "doScrollPos"], function( e, o ){
		...
		var o = c.data( this[e], "__nicescroll" ) || !1;
		return o
	}, e.extend( e.expr[":"], {
		...
		"undefined" == typeof o && ("object" != typeof e || "jquery"in e || (o = e, e = !1));
		var t = new S;
		"undefined" == typeof o && (o = {}), e && (o.doc = c( e ), o.win = c( this ));
		var r = !("doc"in o);
		return r || "win"in o || (o.win = c( this )), this.each( function(){
			var e = c( this ).data( "__nicescroll" ) || !1;
			e || (o.doc = r ? c( this ) : o.doc, e = new v( o, c( this ) ), c( this ).data( "__nicescroll", e )), t.push( e )
		} ), 1 == t.length ? t[0] : t
	}, window.NiceScroll = {
		getjQuery: function(){
			return e
		}
	}, c.nicescroll || (c.nicescroll = new S, c.nicescroll.options = f)
}( jQuery );
